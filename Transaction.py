...
"}")
        ...
        self.logout_pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.logout_pushButton_2.setGeometry(QtCore.QRect(10, 50, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Fixedsys")
        self.logout_pushButton_2.setFont(font)
        self.logout_pushButton_2.setStyleSheet("QPushButton {background-color: rgb(255, 38, 38);\n"
"                        color:rgb(255,255,255);                                \n"
"}\n"
"QPushButton:hover {background-color: rgb(218, 167, 0);\n"
"}")
        self.logout_pushButton_2.setObjectName("logout_pushButton_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/trans_src/mainwindow2.jpg\"/></p></body></html>"))
        ...
        self.logout_pushButton.setText(_translate("MainWindow", "Log Out"))
        self.logout_pushButton_2.setText(_translate("MainWindow", "Inventory"))
